...
class TestBase(unittest.TestCase):
    ...
    def test_to_json_string(self):
        ...
        with self.assertRaises(TypeError):
            Base.to_json_string(01_5)
        self.assertCountEqual(Base.to_json_string(o1_6), '[[1, 2, 3]]')
        self.assertCountEqual(Base.to_json_string(o1_7), '[]')

    def test_from_json_string(self):
        """from_json_string() - testing the format

        Return:
              if there is nothing in the format of the string , return []
        """
    ...
    def test_load_from_file(self):
        """Testing attributes from load file()
        """
